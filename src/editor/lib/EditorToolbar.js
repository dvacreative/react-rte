...
import {ToolbarConfig, CustomControl} from './EditorToolbarConfig';
...
export default class EditorToolbar extends Component {
  ...
  _renderBlockAlignmentButtons(name, toolbarConfig) {
    let {editorState} = this.props;
